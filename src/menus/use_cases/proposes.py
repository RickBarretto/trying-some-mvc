...
def wish_add_to_waiting_queue(clinic: Clinic, patient: Patient) -> bool:
...
def wish_send_patient_to_waiting_queue(clinic: Clinic, patient: Patient) -> bool:
...
def wish_register_patient(clinic: Clinic, patient_cpf: str) -> bool:
...
def wish_book_session(clinic: Clinic, patient: Patient, session: Session) -> bool:
...
def wish_register_session(clinic: Clinic, session_date: str) -> bool:
